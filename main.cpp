...
bool InitData()
{
    ...
    g_window = SDL_CreateWindow("Toi yeu em",
...
int main(int argc, char* argv[])
{
    ...
    while (!Quit_Menu)
    {
        ...
        while (SDL_PollEvent(&e_mouse) != 0)
        {
            ...
            HandlePlayButton(&e_mouse, g_screen, PlayButton, Quit_Menu, Play_Again, g_click, gMap1Button, gMap2Button, gMap3Button, Map1Button, Map2Button, Map3Button, map_file_index, map_tile_index, map_background);
    ...
    while (Play_Again)
    {
        ...
        while (!is_quit)
        {
            if (Game_State)
            {
                ...
                {
                    p_player.HandelInputAction(g_event, g_screen, g_jump);
