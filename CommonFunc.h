...
const int MAP1_BUTTON_POSX = 100;
const int MAP1_BUTTON_POSY = 260;

const int MAP2_BUTTON_POSX = 565;
const int MAP2_BUTTON_POSY = 260;

const int MAP3_BUTTON_POSX = 1030;
const int MAP3_BUTTON_POSY = 260;
